...
const TableData = () => {
  const { parameter, setParameter } = useContext(DocumentContext);
  const [getList, { data, isFetching }] = useLazyGetListDocumentQuery();
  ...
  const dataTable = data as GetListDocumentApiResponse;
